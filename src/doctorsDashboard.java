 ...
 * @author shahd
 */
public class doctorsDashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        totalIncome.setText("doctors income 2024");
 ...
 java.awt.EventQueue.invokeLater(new Runnable() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(doctorsDashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
